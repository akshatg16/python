...
3280 Writing programs (or programming) is a very creative 
and rewarding activity.  You can write programs for 
many reasons, ranging from making your living to solving
502 a difficult data analysis problem to having fun to helping 9014
someone 5910 else 3001 solve 9931 a problem.  This book assumes that 
...
us 2803 do 3020 many 9527 different things.
 6531  2960
...
4586 chapter and tell me the most commonly used word and how 358
...
7600 that humans are not is why you need to become
skilled at talking computer language.  Once you learn
this 3010 new 9767 language, 407 you can delegate mundane tasks
 to your partner (the computer), leaving more time 
2608 for you to do the 
...
your 2438 programs. 8602  8037 As you gain skill as a programmer and
...
9845 Central Processing Unit (or CPU) is 6383
...
7893 memory vanishes when the computer is turned off. 6974

Secondary Memory is also used to store
information, 4491 but 3941 it 185 is much slower than the main memory.
...
3354 do next.  Sometimes you will tell the CPU to use the main memory, 7180
...
7073 We call these stored instructions a program and the act 2095
of writing these instructions down and getting the instructions to 
be correct programming.

4609 Understanding programming
...
analysis 2474 problem 3331 and 4909 develop a program to solve the problem.
...
5625 you combine words and sentences to convey an idea to the reader. 
...
6775 find it much easier to learn a second programming language such
...
7283 You will learn the vocabulary and sentences of Python pretty quickly. 1592
...
4261 simple programs, and then we write increasingly complex programs over time.
...
The 6701 reserved 5131 words 2657 in the language where humans talk to 
...
6343 but for now we will focus on the Python equivalent of speak (in 
...
1266 software on your computer and learn how to start Python on your 9255
...
2613 a terminal or command window and you will type python and 
...
3228 use when they land on a faraway planet and try to speak with the inhabitants 6931
2533 of the planet: 171
...
put 1220 you 9453 on 152 a spit, roast you over a fire, and eat you for dinner.
...
1174 Python is a high-level language intended to be relatively 513
straightforward for humans to read and write and for computers
3107 to read and process.  Other high-level languages include Java, C++,
...
7681 high-level languages can be moved between different computers by using a 
...
8704 it by seven and put the newly computed value in y.  Then we ask Python to print out 311
...
5930 library respectively.  In Linux and Macintosh, there is no suffix that uniquely marks
a 8299 file 8613 as 2800 executable.
 
If you were to open an executable file in a text editor, it would look 
completely 1972 crazy 2579 and 780 be unreadable:
...
be 6249 wondering 5453 a 2416 bit about the Python interpreter itself.  What language is 
 it written in?  Is it written in a compiled language?  When we type
python, what exactly is happening?

2583 The Python interpreter is written in a high-level language called C. 4335
You can look at the actual source code for the Python interpreter by
going to www.python.org and working your way to their source code.
7510 So Python is a program itself and it is compiled into machine code. 4721
When you installed Python on your computer (or the vendor installed it),
9822 you copied a machine-code copy of the translated Python program onto your 4872
...
5078 we use a text editor to write the Python instructions into a file,
